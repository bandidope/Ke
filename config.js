...
[ '529813279747', 'Yane', true ],
[ '51960831611', 'Eli', true ],
[ '56931300864', 'TodoBenne', true ],
  ]
//*─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─⭒─ׄ─ׅ─ׄ─*
...
global.packname = `[ 𝗮𝗿𝗰𝗲𝘂𝘀 𝗯𝗼𝘁 ×͜× ]`
global.author = '𝗮𝗿𝗰𝗲𝘂𝘀 𝗯𝗼𝘁 ×͜×'
global.stickpack = '𝗮𝗿𝗰𝗲𝘂𝘀 𝗯𝗼𝘁 ×͜×'
global.stickauth = '𝗮𝗿𝗰𝗲𝘂𝘀 𝗯𝗼𝘁 ×͜×'
global.wm = '𝗮𝗿𝗰𝗲𝘂𝘀 𝗯𝗼𝘁 ×͜×'
global.dev = '© Developer Whois'
global.wait = '🌪️ *Aɢᴜᴀʀᴅᴇ ᴜɴ ᴍᴏᴍᴇɴᴛᴏ, sᴏʏ ʟᴇɴᴛᴏ... ฅ^•ﻌ•^ฅ\n\n> 𝗮𝗿𝗰𝗲𝘂𝘀 𝗯𝗼𝘁 🤍🌪️*'
global.botname = '[ 𝗮𝗿𝗰𝗲𝘂𝘀 𝗯𝗼𝘁 ×͜× ]'
global.textbot = `𝗮𝗿𝗰𝗲𝘂𝘀 𝗯𝗼𝘁 ×͜×`
global.dev = '• 𝗮𝗿𝗰𝗲𝘂𝘀 𝗯𝗼𝘁 ×͜×'
global.listo = '*Aquí tiene ฅ^•ﻌ•^ฅ*'
global.namechannel = '𝗮𝗿𝗰𝗲𝘂𝘀 𝗯𝗼𝘁 ×͜×'
